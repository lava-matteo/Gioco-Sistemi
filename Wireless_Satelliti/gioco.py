...
class Menu(Entity):
    def __init__(self, **kwargs):
        ...
        self.mappa_sistemi = Button(icon = 'textures/pulsante_1', color = (25, 25, 25), pressed_color = (255, 255, 255, 255), scale = (0.65, 0.11), position = (0, 0.08), parent = self)
        self.esci = Button(icon = 'textures/pulsante_2', color = (25, 25, 25), pressed_color = (255, 255, 255, 255), scale = (0.65, 0.11), position = (0, -0.08), parent = self)
...
class Pausa(Entity):
    def __init__(self, **kwargs):
        ...
        self.continua = Button(icon = 'textures/pulsante_3', color = (25, 25, 25), pressed_color = (255, 255, 255, 255), scale = (0.65, 0.11), position = (0, 0.15), parent = self)
        self.riavvia = Button(icon = 'textures/pulsante_4', color = (25, 25, 25), pressed_color = (255, 255, 255, 255), scale = (0.65, 0.11), position = (0, 0), parent = self)
        self.torna_al_menu = Button(icon = 'textures/pulsante_5', color = (25, 25, 25), pressed_color = (255, 255, 255, 255), scale = (0.65, 0.11), position = (0, -0.15), parent = self)
